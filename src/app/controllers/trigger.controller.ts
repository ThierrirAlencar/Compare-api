...
export class triggerController{
    constructor(
        private _service:triggerService
    ){}
    ...
    @Post("/")
    async create(@Req() req:AuthRequest, @Res() res:Response, @Body() body:createTriggerDTO){
    ...
    async update(@Res() res:Response, @Body() body:updateTriggerDTO, @Query() query:updateTriggerParams){
    ...
    async getAll(@Res() res:Response, @Req() req:AuthRequest){
        ...
        const _res = await this._service.findByUser(uid) as createTriggerSuccessDTO[]
    ...
    async delete(@Res() res:Response, @Body() body:updateTriggerDTO, @Query() query:updateTriggerParams){
        const {targetPrice,status} = body
    ...
    async getone(@Res() res:Response, @Body() body:updateTriggerDTO, @Query() query:updateTriggerParams){
        const {targetPrice,status} = body
