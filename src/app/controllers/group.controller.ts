import { Body, Controller, Post, Put, Delete, Param, UseGuards } from "@nestjs/common";
...
export class GroupController {
  ...
  async create(@Body() body: Prisma.groupsUncheckedCreateInput): Promise<groups> {
  ...
  @ApiNotFoundResponse({ description: "Group not found", type: ErrorResponseDTO })
  async update(
    @Param("id") id: string,
  ...
  async assignPermission(@Body() body: Prisma.group_permissionsUncheckedCreateInput) {
